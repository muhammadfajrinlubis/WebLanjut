                    ...
                    <tbody>
                        @foreach ($mapel as $val => $data)
                            <tr>
                                ...
                                <td>{{ $data->ulangan($val)['ulha_1'] ?? 'Default Value' }}</td>
                                <td>{{ $data->ulangan($val)['ulha_2'] ?? 'Default Value' }}</td>
                                <td>{{ $data->ulangan($val)['uts'] ?? 'Default Value' }}</td>
                                <td>{{ $data->ulangan($val)['ulha_3'] ?? 'Default Value' }}</td>
                                <td>{{ $data->ulangan($val)['uas'] ?? 'Default Value' }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
